    ...
    <table className="min-w-full border-separate border-spacing-y-2 border-spacing-x-2">
      <thead className="hidden border-b lg:table-header-group">
        <tr className="">
          ...
          <td className="whitespace-normal py-4 text-sm font-medium text-gray-500 sm:px-6">Change Status</td>
      ...
      <tbody className="lg:border-gray-300">
        <tr className="">
          ...
          <select name="" className="sm: mr-4 block w-full whitespace-pre rounded-lg border p-1 pr-10 text-base outline-none focus:shadow sm:text-sm">
            ...
            <option className="whitespace-no-wrap text-sm">ACCEPTED</option>
            <option className="whitespace-no-wrap text-sm">REJECTED</option>
          </select>
          </td>
